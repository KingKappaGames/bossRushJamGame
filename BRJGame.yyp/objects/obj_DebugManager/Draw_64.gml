...
if(acceptInput == 1) {
	draw_text_transformed(room_width / 2, room_height / 30, "DEBUG CONSOLE", 3, 3, 0);
}

if(acceptInput == 1) {
	draw_text_transformed(device_mouse_x_to_gui(0), device_mouse_y_to_gui(0), string(mouse_x) + "," + string(mouse_y), .6, .6, 0);
}
